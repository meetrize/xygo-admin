...
type SysGenCodes struct {
	...
	GenType      int         `json:"genType"      orm:"gen_type"      description:"生成类型:10=普通列表,11=树表"` // 生成类型:10=普通列表,11=树表
	...
	Status       int         `json:"status"       orm:"status"        description:"状态:1=已生成,2=未生成"`     // 状态:1=已生成,2=未生成
