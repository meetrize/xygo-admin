...
type SysAttachment struct {
	...
	Width      int    `json:"width"      orm:"width"       description:"宽度"`            // 宽度
	Height     int    `json:"height"     orm:"height"      description:"高度"`            // 高度
	...
	Quote      int    `json:"quote"      orm:"quote"       description:"上传(引用)次数"`      // 上传(引用)次数
