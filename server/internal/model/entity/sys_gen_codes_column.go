...
type SysGenCodesColumn struct {
	...
	IsPk       int    `json:"isPk"       orm:"is_pk"       description:"是否主键:0=否,1=是"`               // 是否主键:0=否,1=是
	IsRequired int    `json:"isRequired" orm:"is_required" description:"是否必填:0=否,1=是"`               // 是否必填:0=否,1=是
	IsList     int    `json:"isList"     orm:"is_list"     description:"表格列显示:0=否,1=是"`              // 表格列显示:0=否,1=是
	IsEdit     int    `json:"isEdit"     orm:"is_edit"     description:"表单编辑显示:0=否,1=是"`             // 表单编辑显示:0=否,1=是
	IsQuery    int    `json:"isQuery"    orm:"is_query"    description:"搜索条件:0=否,1=是"`               // 搜索条件:0=否,1=是
